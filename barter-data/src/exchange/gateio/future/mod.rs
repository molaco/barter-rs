use crate::{
    ...
    exchange::{
        ...
        gateio::{Gateio, GateiotWsStream, candle::GateioKline, perpetual::trade::GateioFuturesTrades},
    },
...
impl<Instrument> StreamSelector<Instrument, Candles> for GateioFuturesUsd
where
    Instrument: InstrumentData,
{
    type SnapFetcher = NoInitialSnapshots;
...
impl<Instrument> StreamSelector<Instrument, Candles> for GateioFuturesBtc
where
    Instrument: InstrumentData,
{
    type SnapFetcher = NoInitialSnapshots;
