...
pub fn rest_client(
    ...
    match (exchange_id, rate_limiter) {
        ...
        (ExchangeId::Okx | ExchangeId::OkxSpot | ExchangeId::OkxPerpetualsUsd, Some(rl)) => Some(Box::new(OkxRestClient::with_rate_limiter(rl))),
        (ExchangeId::Okx | ExchangeId::OkxSpot | ExchangeId::OkxPerpetualsUsd, None) => Some(Box::new(OkxRestClient::new())),
